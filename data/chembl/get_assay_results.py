...
def by_molecules(molecule_chembl_ids):
    ...
    return utils.get_bioactivities_for_molecules(molecule_chembl_ids)

def by_targets(target_chembl_ids):
    """ retrieve the assay results by target_chembl_ids """

    return utils.get_bioactivities_for_targets(target_chembl_ids)
...
def get_targets(chembl_assay_results):
    ...
    target_details = utils.get_target_details(all_targets)
    target_info = dict()
